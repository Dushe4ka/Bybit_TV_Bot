...
broker_url = 'redis://:Ollama12357985@127.0.0.1:14572/10'
result_backend = 'redis://:Ollama12357985@127.0.0.1:14572/10'
...
task_time_limit = 43200  # Максимальное время выполнения задачи (1 час)
task_soft_time_limit = 36000  # Мягкое ограничение времени (50 минут)
